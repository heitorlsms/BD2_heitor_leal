...
INSERT INTO Clientes (CPF, Nome, Sexo, Idade, Endereco, Email, Telefone, Data_cadastro, ID_filial) VALUES 
('12345678901', 'Maria Silva', 'Feminino', '25', 'Rua A, 123', 'maria.silva@gmail.com', '9876543210', '2023-01-01 10:00:00', 1),
('23456789012', 'João Souza', 'Masculino', '30', 'Rua B, 456', 'joao.souza@gmail.com', '9876543211', '2023-01-02 11:00:00', 2),
('34567890123', 'Ana Pereira', 'Feminino', '22', 'Rua C, 789', 'ana.pereira@gmail.com', '9876543212', '2023-01-03 12:00:00', 3),
('45678901234', 'Carlos Santos', 'Masculino', '28', 'Rua D, 101', 'carlos.santos@gmail.com', '9876543213', '2023-01-04 13:00:00', 4),
('56789012345', 'Julia Oliveira', 'Feminino', '26', 'Rua E, 202', 'julia.oliveira@gmail.com', '9876543214', '2023-01-05 14:00:00', 5),
('67890123456', 'Pedro Lima', 'Masculino', '29', 'Rua F, 303', 'pedro.lima@gmail.com', '9876543215', '2023-01-06 15:00:00', 1),
('78901234567', 'Mariana Costa', 'Feminino', '27', 'Rua G, 404', 'mariana.costa@gmail.com', '9876543216', '2023-01-07 16:00:00', 2),
('89012345678', 'Lucas Almeida', 'Masculino', '24', 'Rua H, 505', 'lucas.almeida@gmail.com', '9876543217', '2023-01-08 17:00:00', 3),
('90123456789', 'Larissa Carvalho', 'Feminino', '23', 'Rua I, 606', 'larissa.carvalho@gmail.com', '9876543218', '2023-01-09 18:00:00', 4),
('01234567890', 'Ricardo Araújo', 'Masculino', '31', 'Rua J, 707', 'ricardo.araujo@gmail.com', '9876543219', '2023-01-10 19:00:00', 5);
...
Select Nome, Email, Sexo, ID_cliente, Idade, CPF, Endereco, Telefone, Data_cadastro, ID_filial
from Clientes
order by Nome, Email, Sexo, ID_cliente, Idade, CPF, Endereco, Telefone, Data_cadastro, ID_filial asc;
...
Select ID_reserva, Data_reserva, ID_cliente, Mesa, ID_filial, Capacidade
from Reservas
order by ID_reserva, Data_reserva, ID_cliente, Mesa, ID_filial, Capacidade asc;

Select Nome, ID_fornecedor, CNPJ, Tipo_material, Email, Telefone, Valor_material
from Fornecedores
order by Nome, ID_fornecedor, CNPJ, Tipo_material, Email, Telefone, Valor_material asc;

Select ID_fornecedor, ID_materia, Quantidade, ID_filial
from Estoque
order by ID_fornecedor, ID_materia, Quantidade, ID_filial asc;

Select ID_prato, Nome, Descricao, Valor
from Pratos
order by ID_prato, Nome, Descricao, Valor asc;

Select ID_bebida, Nome, Descricao, Valor
from Bebidas
order by ID_bebida, Nome, Descricao, Valor asc;

Select ID_ingrediente, Nome, Unidade_medida, ID_prato, ID_bebida
from Ingredientes
order by ID_ingrediente, Nome, Unidade_medida, ID_prato, ID_bebida asc;

Select ID_pedido, ID_cliente, ID_prato, ID_bebida, Valor, Tipo_pagamento, Endereco, Data_pedido
from Pedidos
order by ID_pedido, ID_cliente, ID_prato, ID_bebida, Valor, Tipo_pagamento, Endereco, Data_pedido asc;

Select ID_entrega, Endereco, ID_pedido, Data_entrega 
from Entregas
order by ID_entrega, Endereco, ID_pedido, Data_entrega  asc;
